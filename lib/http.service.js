...
var HTTPService = (function () {
    ...
    HTTPService.prototype.parseNumber = function (value, def) {
        if (def === void 0) { def = 0; }
        try {
    ...
    HTTPService.prototype.getConfig = function (name) {
        try {
    ...
    HTTPService.prototype.errorLog = function (name, data) {
        if (!this.logger) {
            return;
        }
        try {
    ...
    HTTPService.prototype.debugLog = function (name, data, type) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2, new Promise(function (resolve, reject) { return __awaiter(_this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            if (url === "") {
                                return [2, reject({ message: "URL invalida" })];
                            }
                            if (!options) {
                                options = {
                                    headers: {
    ...
    HTTPService.prototype.get = function (url, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.request(url, "GET", options)];
            });
        });
    };
    HTTPService.prototype.post = function (url, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.request(url, "POST", options, body)];
            });
        });
    };
    HTTPService.prototype.put = function (url, body, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.request(url, "PUT", options, body)];
            });
        });
    };
    HTTPService.prototype.delete = function (url, options) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, this.request(url, "DELETE", options)];
            });
        });
    };
    var HTTPService_1;
