...
exports.basicdelete = exports.basicput = exports.basicpost = exports.basicget = exports.getToken = void 0;
...
var basicget = function (onApp, done1, url, _body) {
...
var basicpost = function (onApp, done2, url, body) {
    if (body === void 0) { body = {}; }
    var token = (0, exports.getToken)();
    var app = onApp();
    request(app.getHttpServer())
...
var basicput = function (onApp, done3, url, body) {
    if (body === void 0) { body = {}; }
    var token = (0, exports.getToken)();
    var app = onApp();
    request(app.getHttpServer())
...
exports.basicput = basicput;
var basicdelete = function (onApp, done4, url, body) {
    if (body === void 0) { body = {}; }
    var token = (0, exports.getToken)();
    var app = onApp();
    request(app.getHttpServer())
